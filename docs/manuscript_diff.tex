...
analyses, our case studies warrant some \DIFdelbegin \DIFdel{more }\DIFdelend background. Community-based
marine reserves that are implemented within TURFs are a form of
\DIFdelbegin \DIFdel{TURF-reserves}\DIFdelend \DIFaddbegin \DIFadd{TURF-reserve}\DIFaddend , voluntarily established and enforced by local communities.
...
in the Pacific Islands \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{bohnsack_2004,johannes_2002}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{johannes_2002,bohnsack_2004}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . However,
...
and \DIFdelbegin \DIFdel{created }\DIFdelend \DIFaddbegin \DIFadd{helped create }\DIFaddend a legal framework that solves this governance issue:
Fish Refuges \citep{nom}. Fish Refuges can be implemented as \DIFdelbegin \DIFdel{temporal }\DIFdelend \DIFaddbegin \DIFadd{permanent,
temporary }\DIFaddend or partial reserves, which can protect one, some, or all
...
\DIFdelbegin \DIFdel{temporal }\DIFdelend \DIFaddbegin \DIFadd{temporary }\DIFaddend marine reserves within their TURFs with a defined expiration
date (often \DIFdelbegin \DIFdel{5
}\DIFdelend \DIFaddbegin \DIFadd{five }\DIFaddend years). When the expiration date is reached, fishers
can chose to open the reserves to fishing or re-establish them. Our work
focuses on Fish Refuges implemented as community-based TURF-reserves \DIFdelbegin \DIFdel{that occur }\DIFdelend in
...
The other two \DIFdelbegin \DIFdel{TURF-reserves }\DIFdelend \DIFaddbegin \DIFadd{TURF-reserve systems }\DIFaddend are located in Maria Elena and Punta
Herrero, in the Yucatan Peninsula (Fig \ref{fig:map}C). In contrast with
Isla Nativdad, which hosts a \DIFdelbegin \DIFdel{well established }\DIFdelend \DIFaddbegin \DIFadd{well-established }\DIFaddend fishing community, Maria
Elena is a fishing camp \DIFdelbegin \DIFdel{--visited }\DIFdelend \DIFaddbegin \DIFadd{visited }\DIFaddend intermittently during the fishing \DIFdelbegin \DIFdel{season-- belonging }\DIFdelend \DIFaddbegin \DIFadd{season
that belongs }\DIFaddend to the \emph{Cozumel} fishing cooperative\DIFdelbegin \DIFdel{; }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend Punta Herrero is
home to the \emph{José María Azcorra} fishing cooperative, and similar
to Isla Natividad hosts a \DIFdelbegin \DIFdel{local }\DIFdelend \DIFaddbegin \DIFadd{small }\DIFaddend community. Their main fishery is the
...
negative effect observed for Isla Natividad on year 5 \DIFdelbegin \DIFdel{correspond }\DIFdelend \DIFaddbegin \DIFadd{corresponds }\DIFaddend to the
2011 hypoxia events \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{micheli_2012-EU}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . The only positive change
