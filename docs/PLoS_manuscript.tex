...
\begin{flushleft}
{\Large
\textbf\newline{Community-based TURF-reserves in small-scale fisheries} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
