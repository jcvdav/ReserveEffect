...
\cite{green_2017} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend for marine reserves in the Caribbean state that reserves "should be more than twice the size of the home range of adults and juveniles", and suggest that reserves seeking to protect spiny lobsters should have at least 14 km across \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{green_2017}}\hspace{0pt}%DIFAUXCMD
