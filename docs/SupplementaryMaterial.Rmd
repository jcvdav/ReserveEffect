...
conapesca %>% 
  ...
  knitr::kable(digits = 2,
               ...
               caption = "Mean ex-vessel prices (MXP / Kg) for lobster (Panulirus spp.) on each TURF (community) by zone (MC = Caribbean; PN = Pacific) and group (Control = only TURF, Treated = TURF and reserve).",
               booktabs = T)
```
