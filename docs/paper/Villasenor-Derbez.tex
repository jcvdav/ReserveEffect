...
Álvin Suarez\(^{2}\), Arturo Hernández-Velasco\(^{2}\), Stuart
...
\title[Community-based marine reserves: 2018-08-30]{Effectiveness of community-based marine reserves in small-scale
fisheries} 
